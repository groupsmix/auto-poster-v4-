...
-- 9.2: Add timestamp columns to categories
...
CREATE TABLE platform_variants_new (
  id            TEXT PRIMARY KEY,
...
INSERT INTO platform_variants_new SELECT * FROM platform_variants;
DROP TABLE platform_variants;
...
CREATE TABLE social_variants_new (
  id            TEXT PRIMARY KEY,
  product_id    TEXT REFERENCES products(id) ON DELETE CASCADE,
...
INSERT INTO social_variants_new SELECT * FROM social_variants;

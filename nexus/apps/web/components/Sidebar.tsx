...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-40 h-full w-64 bg-sidebar-bg border-r border-sidebar-border flex flex-col transition-transform duration-200 lg:translate-x-0 ${
          ...
          <div className="mt-4 pt-4 border-t border-sidebar-border">
            <ul className="space-y-0.5">
              <li>
                ...
                >
                  <span className={pathname.startsWith(settingsItem.href) ? "text-accent" : ""}>
                    {settingsItem.icon}
                  </span>

/**
 * Reusable empty-state placeholder with an optional SVG illustration.
 *
 * Usage:
 *   <EmptyState icon="products" message="No products match your filters." />
 *   <EmptyState icon="reviews" message="No reviews waiting." action={{ label: "Go to Products", onClick: fn }} />
 */
...
export default function EmptyState({ icon, message, action }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      {icon && ICONS[icon] && (
        <div className="text-muted/40 mb-4">{ICONS[icon]}</div>
      )}
